...
namespace CryptoRtd.ViewModels
{
    public class MainViewModel : ObservableObject
    {
        private ObservableCollection<BinanceSymbolViewModel> allPrices = new ObservableCollection<BinanceSymbolViewModel>();
